...
install some skills - https://github.com/anthropics/skills.git , /plugin marketplace add anthropics/skills , /plugin install document-skills@anthropic-agent-skills
...
## Guidelines
- Guideline 1
- Guideline 2  ,,, https://github.com/vercel-labs/agent-skills.git , https://github.com/vercel-labs/agent-skills.git , npx skills add vercel-labs/agent-skills , https://github.com/vercel-labs/agent-skills.git , uipro init --ai antigravity , uipro init --ai claude  , # Browse all available skills
...
npx skills add bencium/bencium-marketplace -g --skill design-audit ,, claude mcp add chrome-devtools npx -- -y chrome-devtools-mcp@latest , claude plugin marketplace add accesslint/skills
claude plugin install accesslint@accesslint , npx skills add Leonxlnx/taste-skill , npx impeccable install , /impeccable init , npx impeccable update , npx shadcn@latest add https://reactbits.dev/r/<Component>-<LANG>-<STYLE>, npx jsrepo@latest add https://reactbits.dev/r/<Component>-<LANG>-<STYLE> , {
  "registries": {
    "@react-bits": "https://reactbits.dev/r/{name}.json"
  }
} , npx shadcn@latest mcp init --client claude , npx shadcn add @skiper-ui/skiper40 ,, import { Skiper40 } from '@/components/v1/skiper40'; ,, pnpm add clsx framer-motion lucide-react tailwind-merge ,,  ---
name: motion-framer
description: Modern animation library for React and JavaScript. Create smooth, production-ready animations with motion components, variants, gestures (hover/tap/drag), layout animations, AnimatePresence exit animations, spring physics, and scroll-based effects. Use when building interactive UI components, micro-interactions, page transitions, or complex animation sequences.
---
